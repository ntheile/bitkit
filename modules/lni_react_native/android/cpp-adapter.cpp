...
// Automated testing checks Java_com_lnireactnative_LniReactNativeModule and lnireactnative
// by comparing the whole line here.
/*
Java_com_lnireactnative_LniReactNativeModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return lnireactnative::multiply(a, b);
}
*/

// Installer coming from LniReactNativeModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lnireactnative_LniReactNativeModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return lnireactnative::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lnireactnative_LniReactNativeModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return lnireactnative::cleanupRustCrate(*runtime);
}